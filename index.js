...
app.post("/tally", async (req, res) => {
  try {
    ...
    for (const field of fields) {
      ...
      // Массив превращаем в обычный текст
...
// =====================================================
// ВСПОМОГАТЕЛЬНАЯ ФУНКЦИЯ
// ПОЛУЧЕНИЕ DISCORD USERNAME ИЗ ЗАЯВКИ
// =====================================================

function getApplicantUsername(message) {
