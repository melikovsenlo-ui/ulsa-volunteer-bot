...
client.once("ready", async () => {
  const infoChannel = await client.channels.fetch("1544134320120406057");

  const infoEmbed = new EmbedBuilder()
    .setTitle("🦫 ULSA VOLUNTEER CENTER")
    .setDescription(`## О ВОЛОНТЁРСКОМ ЦЕНТРЕ

**ULSA Volunteer Center** — подразделение университета, координирующее волонтёрскую деятельность студентов и организацию общественно полезных инициатив.

Центр объединяет студентов, заинтересованных в помощи университетскому сообществу, участии в социальных проектах и проведении различных мероприятий.

### 🤝 ЧЕМ ЗАНИМАЕТСЯ VOLUNTEER CENTER

• организация и проведение университетских мероприятий;
• общественные и благотворительные инициативы;
• помощь студентам и участникам мероприятий;
• экологические и общественные проекты;
• организация спортивных и оздоровительных мероприятий;
• поддержка социальных инициатив;
• участие в проектах, направленных на развитие университетского сообщества.

### 🎓 КТО МОЖЕТ СТАТЬ ВОЛОНТЁРОМ

В состав ULSA Volunteer Center могут вступать студенты университета, заинтересованные в добровольческой деятельности.

Для участия необходимо:

**01.** Ознакомиться с правилами Volunteer Center.

**02.** Заполнить заявку на вступление.

**03.** Предоставить необходимую информацию о себе и своей доступности.

**04.** Дождаться рассмотрения заявки руководством Volunteer Center.

**05.** После одобрения приступить к волонтёрской деятельности.

### 🕐 УЧАСТИЕ В ПРОЕКТАХ

Волонтёр может принимать участие как в отдельных мероприятиях, так и в регулярных проектах Volunteer Center.

Если участие становится невозможным, необходимо заранее уведомить руководителя или ответственного организатора.
